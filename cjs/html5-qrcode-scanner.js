...
(function (Html5QrcodeScannerStatus) {
  Html5QrcodeScannerStatus[(Html5QrcodeScannerStatus["STATUS_DEFAULT"] = 0)] =
    "STATUS_DEFAULT";
  Html5QrcodeScannerStatus[(Html5QrcodeScannerStatus["STATUS_SUCCESS"] = 1)] =
    "STATUS_SUCCESS";
  Html5QrcodeScannerStatus[(Html5QrcodeScannerStatus["STATUS_WARNING"] = 2)] =
    "STATUS_WARNING";
  Html5QrcodeScannerStatus[
    (Html5QrcodeScannerStatus["STATUS_REQUESTING_PERMISSION"] = 3)
...
var Html5QrcodeScanner = (function () {
  function Html5QrcodeScanner(elementId, config, verbose) {
    ...
    this.scanTypeSelector = new scan_type_selector_1.ScanTypeSelector(
  ...
  Html5QrcodeScanner.prototype.render = function (
    ...
    this.qrCodeSuccessCallback = function (decodedText, result) {
      if (qrCodeSuccessCallback) {
        ...
        _this.setHeaderMessage(
          strings_1.Html5QrcodeScannerStrings.lastMatch(decodedText),
    ...
    this.html5Qrcode = new html5_qrcode_1.Html5Qrcode(
  ...
  Html5QrcodeScanner.prototype.pause = function (shouldPauseVideo) {
    if (
      (0, core_1.isNullOrUndefined)(shouldPauseVideo) ||
  ...
  Html5QrcodeScanner.prototype.applyVideoConstraints = function (
    videoConstaints
  ) {
  ...
  Html5QrcodeScanner.prototype.createBasicLayout = function (parent) {
    ...
    if (
      scan_type_selector_1.ScanTypeSelector.isCameraScanType(
  ...
  Html5QrcodeScanner.prototype.createCameraListUi = function (
    scpCameraScanRegion,
    ...
    $this.setHeaderMessage(
      strings_1.Html5QrcodeScannerStrings.cameraPermissionRequesting()
    );
    ...
    html5_qrcode_1.Html5Qrcode.getCameras()
      .then(function (cameras) {
        ...
        if (cameras && cameras.length > 0) {
          ...
          $this.setHeaderMessage(
            strings_1.Html5QrcodeScannerStrings.noCameraFound(),
  ...
  Html5QrcodeScanner.prototype.createPermissionButton = function (
    scpCameraScanRegion,
    requestPermissionContainer
  ) {
    var $this = this;
    var requestPermissionButton = base_1.BaseUiElementFactory.createElement(
      "button",
  ...
  Html5QrcodeScanner.prototype.createPermissionsUi = function (
    scpCameraScanRegion,
    requestPermissionContainer
  ) {
    var $this = this;
    if (
      ...
      permissions_1.CameraPermissions.hasPermissions()
  ...
  Html5QrcodeScanner.prototype.renderFileScanUi = function (parent) {
    var showOnRender = scan_type_selector_1.ScanTypeSelector.isFileScanType(
      this.currentScanType
    );
    var $this = this;
    var onFileSelected = function (file) {
      ...
      if (
        !scan_type_selector_1.ScanTypeSelector.isFileScanType(
          $this.currentScanType
        )
      ) {
        return;
      ...
      $this.setHeaderMessage(
        strings_1.Html5QrcodeScannerStrings.loadingImage()
      );
      $this.html5Qrcode
        ...
        .catch(function (error) {
          ...
          $this.qrCodeErrorCallback(
            error,
            core_1.Html5QrcodeErrorFactory.createFrom(error)
          );
        });
    };
    this.fileSelectionUi = file_selection_ui_1.FileSelectionUi.create(
      parent,
      showOnRender,
      onFileSelected
    );
  ...
  Html5QrcodeScanner.prototype.renderCameraSelection = function (cameras) {
    var _this = this;
    var $this = this;
    var scpCameraScanRegion = document.getElementById(
      this.getDashboardSectionCameraScanRegionId()
    );
    scpCameraScanRegion.style.textAlign = "center";
    var cameraZoomUi = camera_zoom_ui_1.CameraZoomUi.create(
      scpCameraScanRegion,
      false
    );
    ...
    var cameraSelectUi = camera_selection_ui_1.CameraSelectionUi.create(
      scpCameraScanRegion,
      cameras
    );
    var cameraActionContainer = document.createElement("span");
    var cameraActionStartButton = base_1.BaseUiElementFactory.createElement(
      "button",
      base_1.PublicUiElementIdAndClasses.CAMERA_START_BUTTON_ID
    );
    ...
    var createAndShowTorchButtonIfSupported = function (cameraCapabilities) {
      ...
      if (!torchButton) {
        torchButton = torch_button_1.TorchButton.create(
  ...
  Html5QrcodeScanner.prototype.createSectionSwap = function () {
    var $this = this;
    var TEXT_IF_CAMERA_SCAN_SELECTED =
      strings_1.Html5QrcodeScannerStrings.textIfCameraScanSelected();
    var TEXT_IF_FILE_SCAN_SELECTED =
      strings_1.Html5QrcodeScannerStrings.textIfFileScanSelected();
    var section = document.getElementById(this.getDashboardSectionId());
    var switchContainer = document.createElement("div");
    switchContainer.style.textAlign = "center";
    var switchScanTypeLink = base_1.BaseUiElementFactory.createElement(
      "span",
  ...
  Html5QrcodeScanner.prototype.startCameraScanIfPermissionExistsOnSwap =
    function () {
      var _this = this;
      var $this = this;
      if (this.persistedDataManager.hasCameraPermissions()) {
        permissions_1.CameraPermissions.hasPermissions()
          .then(function (hasPermissions) {
            if (hasPermissions) {
              var permissionButton = document.getElementById(
                $this.getCameraPermissionButtonId()
              );
              if (!permissionButton) {
  ...
  Html5QrcodeScanner.prototype.setHeaderMessage = function (
    messageText,
    scannerStatus
  ) {
    if (!scannerStatus) {
  ...
  Html5QrcodeScanner.prototype.showHideScanTypeSwapLink = function (
    shouldDisplay
  ) {
    if (this.scanTypeSelector.hasMoreThanOneScanType()) {
  ...
  Html5QrcodeScanner.prototype.insertCameraScanImageToScanRegion = function () {
    ...
    this.cameraScanImage.alt =
      strings_1.Html5QrcodeScannerStrings.cameraScanAltText();
  };
  Html5QrcodeScanner.prototype.insertFileScanImageToScanRegion = function () {
    ...
    this.fileScanImage.alt =
      strings_1.Html5QrcodeScannerStrings.fileScanAltText();
  };
  ...
  Html5QrcodeScanner.prototype.getDashboardSectionCameraScanRegionId =
    function () {
